...
----Return Orders Customer Feedback--

--------------------Sample Input---------------------------------------------

DROP TABLE Flipkart_tb
...
SELECT customer_name,  CAST  (([Return Count]*1.0/[Total Order] * 1.0)*100 AS DECIMAL(4,2))      AS '% Of Return' FROM CTE_A
WHERE CAST  (([Return Count]*1.0/[Total Order] * 1.0)*100 AS DECIMAL(4,2))>=75.00
